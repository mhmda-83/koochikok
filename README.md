...
import [Postman Collection](Koochikok%20(Redis).postman_collection.json) and [Postman Environment](Koochikok%20[DEV].postman_environment.json) to use the APIs
